...
export type Scheme = 'cluster' | 'flick' | 'ring' | 'ring8';
export const SCHEMES: Scheme[] = ['cluster', 'flick', 'ring', 'ring8'];
export const LABELS: Record<Scheme, string> = { cluster: 'thumb cluster', flick: 'weapon disc · flick', ring: 'guard ring · v7', ring8: 'guard ring · v8' };
