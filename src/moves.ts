...
export const MOVES: Record<MoveId, MoveDef> = {
  ...
  skill_lunge: skill('skill_lunge', THRUST_TIMING, { direction: 'thrust', damage: 20, stagger: 22, staminaDamage: 30, posture: 20, knockback: 3, stepIn: 0, reach: 1.6 }),   // the Nightborn's Estoc Lunge. RV15 (Strategy 2026-09-26): reach 2.4 -> 1.6, stepIn 1 -> 0 — the landed cast from outside the knife's reach farmed the Goblin (estoc v Goblin 22/24, bar 12) and reach is the only knob that moves it; the "longest reach" identity is Combat's to win back post-live with another lever
  ...
  skill_ironrush: skill('skill_ironrush', THRUST_TIMING, { direction: 'thrust', damage: 20, stagger: 22, staminaDamage: 30, posture: 20, knockback: 3, stepIn: 0, reach: 1.6, poise: 24, poiseFrom: 8 }),   // the Knight's (RV15: reach 2 -> 1.6, stepIn 1 -> 0, the same Goblin farm as the Lunge): armoured from tick 8 against every plain blow (a light's stagger 24 equals a heavy's; the guard counter, critical and skills get through)
