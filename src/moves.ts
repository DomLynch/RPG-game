...
// cleaver's flip is `cleaver: CLEAVER` here plus its manifest entry (artifacts/weapons/REQUESTS.md §5); the knife's is `knife: KNIFE` plus
// its entry (§9); until then the Pitborn's and the goblin's slots borrow the longsword exactly as before.
