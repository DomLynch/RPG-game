...
export const ROSTER = {
  ...
  knight: { name: 'the Knight', body: 'knight', rig: 'hero', archetype: 'knight', weapon: 'maul', finishers: ['plainDeath'], hold: true },   // finishers: none validated on this body yet (the Dwarf rule); the harness pass adds them
