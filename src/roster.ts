...
export const ROSTER = {
  ...
  plaguedoctor: { name: 'the Plague Doctor', body: 'plaguedoctor', rig: 'hero', archetype: 'plagueDoctor', weapon: 'longsword', finishers: ['splitCrown', 'decapitation', 'runThrough', 'opened', 'plainDeath'] },   // finishers: none validated on this body yet (the Dwarf rule); the harness pass adds them
  ...
  knight: { name: 'the Knight', body: 'knight', rig: 'hero', archetype: 'knight', weapon: 'maul', finishers: ['splitCrown', 'decapitation', 'runThrough', 'opened', 'plainDeath'] },   // finishers: none validated on this body yet (the Dwarf rule); the harness pass adds them
  ...
  witch: { name: 'the Witch', body: 'witch', rig: 'hero', archetype: 'witch', weapon: 'trident', finishers: ['splitCrown', 'decapitation', 'runThrough', 'opened', 'plainDeath'] },
  // Brief 15 (Dom, 2026-09-23: into beta now): a Norse woman on the realistic female body, reference A (#498), the gladius. Her archetype
  // is a placeholder copy of the Pitborn's profile until Combat's retune (moves.ts ARCHETYPES.shieldmaiden).
  shieldmaiden: { name: 'the Shieldmaiden', body: 'shieldmaiden', rig: 'hero', archetype: 'shieldmaiden', weapon: 'gladius' },
