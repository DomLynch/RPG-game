...
// Only the clips that exist today (owner 2026-09-19): Split Crown, Decapitation, Run Through, The Quiet One — plus Plain death as the
// no-finisher control. The rest of the spec table (opened/hamstrung/execution) has no clip yet and would silently
// play the plain Death, which reads as a bug in a test menu. Add each back the day its clip ships.
const FINISHER_OPTIONS: [string, string][] = [['splitCrown', 'Split Crown'], ['decapitation', 'Decapitation'], ['runThrough', 'Run Through'], ['quietOne', 'The Quiet One'], ['plainDeath', 'Plain death']];
