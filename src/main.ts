...
import { LOOT, PACK, PAPERDOLL, SKILLS, takenTier, decline, emptyLoot, fightWeapon, isLootId, isSkillId, isWeaponLoot, lootName, paperdollOf, packFull, recordTaken, skillOf, slotOf, stow, store, takeWouldDrop, displacedBy, unwear, wear, wearFromPack, wearTaken, type Loot, type LootId, type Paperdoll } from './loot.ts';
