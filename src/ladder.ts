...
export const LADDER: { id: OpponentId; name: string }[] = [{ id: 'veteran', name: 'the Veteran' }, { id: 'pitborn', name: 'the Pitborn' }, { id: 'goblin', name: 'the Goblin' }, { id: 'nightborn', name: 'the Nightborn' }];   // reach → pressure → speed → restraint (the goblin took his rung in slice X)
