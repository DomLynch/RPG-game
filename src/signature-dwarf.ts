...
export const STAMP = { size: 0.075, opacity: 0.92, fadeIn: 0.06, tilt: 0.35 } as const;   // metres across; appears on the frame of the blow
...
function stampArt(): THREE.Texture | null {
  ...
  halo.addColorStop(0, 'rgba(120,108,96,0.55)'); halo.addColorStop(1, 'rgba(120,108,96,0)');
  ...
  g.fillStyle = 'rgba(28,22,20,0.95)'; g.fillRect(c - face, c - face, face * 2, face * 2);
  g.lineWidth = size * 0.035;
  g.strokeStyle = 'rgba(190,176,160,0.8)'; g.beginPath(); g.moveTo(c - face, c + face); g.lineTo(c - face, c - face); g.lineTo(c + face, c - face); g.stroke();
  ...
  g.strokeStyle = 'rgba(150,132,118,0.85)'; g.lineWidth = size * 0.03; g.lineJoin = 'miter';
