...
try {
 ...
 await page.getByRole('button',{name:'Menu and field journal'}).tap();await page.getByRole('button',{name:'Controls: swipes (trial)',exact:true}).tap();await page.getByRole('button',{name:'Close journal'}).tap();
