...
# --boots: foot and ball bones fill Boots rather than Greaves — a sabaton is its own piece (the Knight's six; Dom, 2026-09-23).
if '--boots' in args:
    SLOT_OF = [(b, 'Boots' if b in ('foot', 'ball') else s) for b, s in SLOT_OF]
