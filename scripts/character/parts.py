...
KIT = {'hero': {'linen': (0.52, 0.47, 0.37), 'grime': 0.55, 'greaves': False, 'build': False, 'bare': False, 'brute': False, 'helm': True, 'barefoot': False, 'ears': False},
       ...
       # at pitborn scale (BUILD.executioner, 1.13). The helm slot carries the iron half-mask + ragged hood; leather buckle
       # harness over bare arms (see artifacts/source/face/executioner/reference/). Greaves and boots; ears under the hood.
