...
KIT = {'hero': {'linen': (0.52, 0.47, 0.37), 'grime': 0.55, 'greaves': False, 'build': False, 'bare': False, 'brute': False, 'helm': True},
       ...
       'pitborn': {'linen': (0.34, 0.31, 0.27), 'grime': 0.88, 'greaves': False, 'build': True, 'bare': True, 'brute': True, 'helm': False},
       ...
       'nightborn': {'linen': (0.13, 0.12, 0.15), 'grime': 0.30, 'greaves': False, 'build': False, 'bare': False, 'brute': False, 'helm': False, 'closed': True, 'collar': True, 'boots': True}}[FIGHTER]  # build: the heavier frame (B2 of the body brief)
...
def level1_kit():
    ...
    for foot, ball, side in [] if KIT['bare'] or KIT.get('boots', False) else [(foot_l, joint('ball_l'), 1), (foot_r, joint('ball_r'), -1)]:
        name = 'l' if side > 0 else 'r'
