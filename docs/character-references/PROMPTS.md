...
**Differentiation from the Executioner was checked, not assumed.** His own reference sat beside the candidates with a
shoulder-width-over-height ratio measured off each silhouette: Executioner **0.36**, the three Knight variants
**0.39-0.40**. So mass is *not* what separates them - the separator is that the Executioner's outline is **soft** (hood,
