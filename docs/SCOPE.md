...
- **Ten archetypes**: the six above + Shieldmaiden (Brief 15, Pitborn lane; *replaces "the Nord"*), Witch (Brief 16, Multi Chars;
  ...
  Plague Doctor, Witch; the line below is superseded for these four. Previously: all four were launch scope, not beta; bodies land one at a time in that cost order; masked characters wait on an
