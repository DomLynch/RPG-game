...
2. **Anatomy capacity + incompatibility.** Stability budget (a giant's arm costs more than a human's); some parts hate each
   other; rare forbidden pairs hide a bonus. This is what makes grafting a decision, not a stat.
3. **Monster-specific graft moves.** You inherit the move you saw the creature do (stomp, grab, leap). Discrete, readable,
   taught by fighting. Before a duel you pick a small active set (deckbuilder rule) so phone controls stay clean.
...
- **Evolution as the identity layer.** Human → Chimera / Demonkin / Vampire / Beast by what you graft. Visual + narrative;
  it does NOT replace the ten-title ladder (rank = identity stays).
- **Bosses steal you.** Lose to a boss, it wears your part next time; beat it, get both back.
- **Visible battle damage** on the fighter (horns crack, veins glow, arm weakens) — already our presentation rule.
