...
**Open.** #735 review (Lead) and the floor ruling (Strategy). #726 in the post-playtest chain. Finding B. Dom's iPhone re-check of the steps on 3f8e5e1c (in #722's body: stick held and moving, fast double-taps on STAB, the floor beside it, the health bars; two-finger spread on the bars; two-finger rotate on the canvas; journal must still scroll).
