...
**World (Dom via Strategy, 15:1x):** #537's fighter rim reads as a WHITE OUTLINE on the phone. One pass: grey + lower opacity so it reads as lighting, or revert the fighter rim only (keep the crowd/sand/wall). PR with two 375x812 same-frame stills (pre-#537 vs tuned); next non-sim batch; Dom judges.
