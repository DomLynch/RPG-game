...
Without both environment values the account panel stays hidden and guest play is unchanged. Do not release a nonfunctional sign-in button. Actual Supabase project creation, migration, Google configuration, production CSP and live login remain blocked on dashboard access as of this change.
