...
|---|---|---|---|---|---|---|
| Light cut (R/L) | 20 / 8 / 22 (333 ms tell, 133 ms sweep) | 11 | 20 | 24 | 1.65 (lands ≤ 1.75) | a hook with a sword: a short raised load on one side, one ~110° arc through the front, a stop past the target, then a lift back to guard (never behind the body, never a swing back; Slash alternates right-to-left and the backhand); chains: opposite cut or heavy within 18 ticks → chained timing 16/8/18 (heavy 22/5/31); posture 20; block costs the defender 15; feintable to tick 10; hold = chambered at tick 9 |
