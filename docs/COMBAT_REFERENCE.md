...
The **Pitborn** was tuned 2026-09-20 (owner): reaction 18 → 14 and lapse .3 → .1 at normal (hard 14 → 12, .1 → .08). He was the softest rung — the hero's own brain beat him 41/48, mostly by stop-hitting him as he walked in; he now notices the stab in time to block it. Hero brain 13/24 after (the Veteran's own 13); the whiff punisher stays his answer (9/24); pinned in `tests/opponents.test.ts`.

The **Executioner** (opponent 5; scythe, 1.36×, 160 hp, poise 12, the shared PROFILES) got his fairness gate 2026-09-20: caps at normal and hard, every script touched, an honest script beats him at normal (the charged heavy through his shaft guard, 4/24 — the whiff punisher does not: the scythe walks through a backstep), a man parked at 1.2 or 1.6 m is killed, AI-vs-AI median 26.5 s. Writing it found a freeze at hard: hard plans cuts half the time, the scythe's cut has a 1.4 m point, and a man standing inside it was never attacked — a planned cut inside its own point now becomes the heavy or the thrust when one can be thrown from there (`ai.ts`; general, but only weapons with a pointed cut — scythe, reaper — are affected).
