...
import { initialPractice, stepPractice } from '/private/tmp/claude-501/-Users-domininclynch-Desktop-Business-frankendom--claude-worktrees-pensive-goodall-2f90b0/b4d35bc8-416e-48b7-ac18-e4afc3911871/scratchpad/wt-scorch/src/combat.ts';
import { OPPONENTS } from '/private/tmp/claude-501/-Users-domininclynch-Desktop-Business-frankendom--claude-worktrees-pensive-goodall-2f90b0/b4d35bc8-416e-48b7-ac18-e4afc3911871/scratchpad/wt-scorch/src/moves.ts';
import { idleIntent, legal } from '/private/tmp/claude-501/-Users-domininclynch-Desktop-Business-frankendom--claude-worktrees-pensive-goodall-2f90b0/b4d35bc8-416e-48b7-ac18-e4afc3911871/scratchpad/wt-scorch/src/duel.ts';
import { createRecorder, encodeRecord } from '/private/tmp/claude-501/-Users-domininclynch-Desktop-Business-frankendom--claude-worktrees-pensive-goodall-2f90b0/b4d35bc8-416e-48b7-ac18-e4afc3911871/scratchpad/wt-scorch/src/record.ts';
for (const foe of ['witch', 'veteran', 'executioner', 'goblin', 'pitborn', 'knight']) for (let seed = 731; seed < 771; seed++) for (const castAt of [0.9, 1.1]) {
  ...
  if (hitTick !== null) {
    ...
    writeFileSync('scorch-replay.txt', link); console.log(JSON.stringify({ foe, seed, castAt, hitTick, ticks: record.ticks, chars: link.length })); process.exit(0);
  }
}
console.log('none');
