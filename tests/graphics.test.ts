...
import * as gearStats from '../src/gear-stats.ts';   // the fight's Loadout from the server's awards (brief 19): main.ts resolves it at boot and on every equip
