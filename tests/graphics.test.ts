...
test('Phase L: boot tells the scene the fight tier, the player\'s rank (a fresh fighter is a Recruit)', () => {
  assert.equal(boot().tier, 'Recruit');
});
