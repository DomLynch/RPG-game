...
function boot(profileExtras: Record<string, unknown> = {}, initializationError?: Error, seed: Record<string, string> = {}, search = '') {
  ...
  let tourStops = 0, sceneWeapon: Promise<string> | undefined;
