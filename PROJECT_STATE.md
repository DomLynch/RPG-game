...
- Held now: minotaur, werewolf. Wraith and Skeleton stay live pending the owner's word (the lead reads the beta freeze as all four). Dist 29.89 → 23.30 MB gzip; per-fight worst opponent is now the Skeleton (8.72 MB of 12). 309/309 before the trunk merge, 310/310 after; quality gate green incl. the browser gate; picker probe: two options disabled, seven live.
