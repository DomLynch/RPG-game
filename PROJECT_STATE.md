...
| Weapons | [docs/state/weapons.md](docs/state/weapons.md) | 25 | 2026-09-23 — Now: loot.glb cuts (shieldmaiden Gladius + plaguedoctor Longsword); gladius + estoc live, maul on roster-v0 |
