...
| Code quality | [docs/state/code-quality.md](docs/state/code-quality.md) | 5 | 2026-09-24 — trunk audit for Dom (c1bbd1b2 all green), #700 fighter-map retry + roster map contract (to Deploy), Stop gate stays targeted |
