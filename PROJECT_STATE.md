...
| Code quality | [docs/state/code-quality.md](docs/state/code-quality.md) | 4 | 2026-09-23 — #567 iPhone half-canvas fix (READY), #556 loot-smoke wired (row 34), #534 fully green at c4bfb54 |
