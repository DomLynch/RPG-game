...
- Commands:
  ...
  - The opponent is `src/assets/veteran.glb` (2026-09-16): `details-opponent.png` is the Veteran's own close-up sheet and
    `faces.png` puts both heads side by side from the portrait angles (front, ±35°, ±90°, from below).
