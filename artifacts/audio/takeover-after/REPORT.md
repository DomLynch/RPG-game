# Combat audio render — takeover-after

Revision 32f783e (dirty tree) · seed 731 · 48000 Hz mono · audio path: sprite, formats tried in order ["opus","aac"] · rendered 2026-09-19T09:03:00.551Z through Chromium OfflineAudioContext via `node scripts/audio-preview.mjs --label takeover-after`.
...
| cue | LUFS-I | phone LUFS | LUFS-M max | peak dBFS | onset ms | length ms | Δ LUFS-I vs takeover-before | Δ phone vs takeover-before |
|---|---|---|---|---|---|---|---|---|
...
| guard-broken | -14.7 | -16.7 | -11.3 | -2.8 | 6 | 796 | +0.1 | +0.2 |
| guard | — | — | — | — | — | 0 | — | — |
| parry-attempt | — | — | — | — | — | 0 | — | — |
| feint | — | — | — | — | — | 0 | — | — |
| roll | -29 | -29.4 | -27.5 | -11.3 | 7 | 295 | -4.6 | -4.8 |
| backstep | -33.8 | -34.1 | -33.8 | -14.2 | 6 | 166 | — | — |
| dodged | — | — | — | — | — | 0 | — | — |
| missed | — | — | — | — | — | 0 | — | — |
| staggered | — | — | — | — | — | 0 | — | — |
| posture-broken | — | — | — | — | — | 0 | — | — |
| exhausted | — | — | — | — | — | 0 | — | — |
| killed | -12.7 | -14 | -9.8 | -2.8 | 6 | 919 | -0.2 | -0.3 |

## Payload
Shipped audio assets (src/assets/audio): 641783 B raw · 605004 B gzip (baseline 577024 B raw · 544298 B gzip; Δ 60706 B gzip). Lane budget: ≤ 1.0 MB gzip.
